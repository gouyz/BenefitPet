//
//  BPBenefitPetCertificateVC.swift
//  BenefitPet
//  益宠认证
...
class BPBenefitPetCertificateVC: GYZBaseVC {
    ...
    override func viewDidLoad() {
        ...
        self.navigationItem.title = "益宠认证"
    ...
    func requestUpdateImg(){
        ...
        imgParam.name = "renzheng"
        imgParam.fileName = "renzheng.jpg"
        imgParam.mimeType = "image/jpg"
        imgParam.data = UIImageJPEGRepresentation(selectImg!, 0.5)
        
        GYZNetWork.uploadImageRequest("doctor/file_renzheng", parameters: ["id":userDefaults.string(forKey: "userId") ?? ""], uploadParam: [imgParam], success: { (response) in
